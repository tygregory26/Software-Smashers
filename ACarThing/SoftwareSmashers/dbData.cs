...
class dbData {
    ...
    public dbData() {
        try {
            ...
            connection.ConnectionString = "server=" + server + ";uid=" + username + ";pwd=" + password + ";database="
                    + databaseName;
            connection.Open();
...
{ 
 ...
 // query failed
        ...
        { 
            try
            { 
                string query = "UPDATE `group1-csci463_ACarThing`.vehicle SET carName = '" + name + "' WHERE carID = " + carID + "; "; 
                MySqlCommand command = new MySqlCommand(query, connection); 
                command.ExecuteNonQuery(); 
                return true; 
         }
        ...
        { 
            ...
            { 
                ...
                { 
                    ...
                    string insert = "INSERT INTO `group1-csci463_ACarThing`.drivers (driverLink, vehicleLink) VALUES (" + userID + ", " + carID + "); "; 
        ...
        { 
            try
            { 
                string query = "UPDATE `group1-csci463_ACarThing`.vehicle SET isStarted = " + (newValue ? 1 : 0) + " WHERE carID = " + carID + "; "; 
                MySqlCommand command = new MySqlCommand(query, connection); 
                command.ExecuteNonQuery(); 
                return true; 
         }
        ...
        { 
            try
            { 
                string query = "UPDATE `group1-csci463_ACarThing`.vehicle SET windowsUp = " + (newValue ? 1 : 0) + " WHERE carID = " + carID + "; "; 
                MySqlCommand command = new MySqlCommand(query, connection); 
                command.ExecuteNonQuery(); 
                return true; 
         }
        ...
        { 
            try
            { 
                string query = "UPDATE `group1-csci463_ACarThing`.vehicle SET doorsLocked = " + (newValue ? 1 : 0) + " WHERE carID = " + carID + "; "; 
                MySqlCommand command = new MySqlCommand(query, connection); 
                command.ExecuteNonQuery(); 
                return true; 
         }
        ...
        { 
            try
            { 
                string query = "UPDATE `group1-csci463_ACarThing`.vehicle SET alarmArmed = " + (newValue ? 1 : 0) + " WHERE carID = " + carID + "; "; 
                MySqlCommand command = new MySqlCommand(query, connection); 
                command.ExecuteNonQuery(); 
                return true; 
         }
